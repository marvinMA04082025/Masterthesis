...
img_p10_path = r"C:\\Users\\Marvin\\Desktop\\Masterarbeit\\Bilder von Python\\Drilling_decision_P10_two_drillings.png"
img_p50_path = r"C:\\Users\\Marvin\\Desktop\\Masterarbeit\\Bilder von Python\\Drilling_decision_P50_two_drillings.png"
img_p90_path = r"C:\\Users\\Marvin\\Desktop\\Masterarbeit\\Bilder von Python\\Drilling_decision_P90_two_drillings.png"
...
ax.text(*success_n, "Success\nEMV = 44,62 Mio. €",      ha="center", va="center", bbox=bbox_kwargs, fontsize=10) #44,62 ergibt aus aus den EMV der einzelnen Verteilungen
ax.text(*failure_n, "Failure\nEMV = -8,4 Mio. €",  ha="center", va="center", bbox=bbox_kwargs, fontsize=10)

# Unterpfad‑Labels (P10/P50/P90) – mittig auf den Ästen
label_props = dict(ha="center", va="center", fontsize=9)
ax.text((success_n[0]+p10_lf[0])/2, (success_n[1]+p10_lf[1])/2 + 0.02, "P10 of drilling costs", **label_props)
ax.text((success_n[0]+p50_lf[0])/2, (success_n[1]+p50_lf[1])/2,             "P50 of drilling costs", **label_props)
ax.text((success_n[0]+p90_lf[0])/2, (success_n[1]+p90_lf[1])/2 - 0.02, "P90 of drilling costs", **label_props)
