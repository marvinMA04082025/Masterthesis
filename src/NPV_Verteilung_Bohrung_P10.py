...
OPEX_P10, OPEX_P50, OPEX_P90 = 1_842_494.42, 2_493_592.47, 3_218_984.25 # habe ich aus NPV-_bokrosten alle ps richtig
PRICE_PER_MWH, OPEX_GROWTH, DISCOUNT_RATE = 80.0, 0.02, 0.06
YEARS, N_SIM, RNG_SEED = 30, 10_000, 42

# -------- Hilfsfunktion für Lognormalparameter --------
...
plt.axvline(0, linestyle="dashed")  # Break‑even
