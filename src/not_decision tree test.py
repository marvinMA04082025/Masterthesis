...
# -------------------------------------------------
npv_success_values = [31.35, 48.75, 66.28]   # Mio €, Durchschnittswerte der Diagramme
npv_failure = -5.6                           # Mio €
...
img_p10_path = r"C:\\Users\\Marvin\\Desktop\\Masterarbeit\\Bilder von Python\\Drilling_decision_P10.png"
img_p50_path = r"C:\\Users\\Marvin\\Desktop\\Masterarbeit\\Bilder von Python\\Drilling_decision_P50.png"
img_p90_path = r"C:\\Users\\Marvin\\Desktop\\Masterarbeit\\Bilder von Python\\Drilling_decision_P90.png"

def load_or_placeholder(path: str, size=(200, 200, 3)):
    """Versucht, ein Bild zu laden; liefert ansonsten einen grauen Platzhalter."""
    if os.path.exists(path):
        return mpimg.imread(path)
    return np.full(size, 0.8)  # grauer Platzhalter (RGB-Wert 0.8)

img_success_dist = load_or_placeholder(img_success_dist_path)  # ← wird jetzt verwendet!
...
ax.text(*success_n, "Success",           ha="center", va="center", bbox=bbox_kwargs, fontsize=10)
ax.text(*failure_n, "Failure",           ha="center", va="center", bbox=bbox_kwargs, fontsize=10)

# Unterpfad-Labels (P10/P50/P90)
...
# ➡️ Koordinate für die Erfolgs-Verteilungs-Grafik
success_dist_pos = (success_n[0], success_n[1] + 0.15)  # direkt oberhalb des Success-Knotens
...
add_img(ax, img_success_dist, success_dist_pos, zoom=0.32)  # ➡️ NEU

plt.title("Decision tree – drilling costs with subsidies", fontsize=13, pad=15)
plt.tight_layout()
plt.show()
